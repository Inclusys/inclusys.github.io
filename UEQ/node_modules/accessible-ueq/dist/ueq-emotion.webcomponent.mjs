(function () {
  ...
  class ElementInternals {
    ...
    setValidity(validityChanges, validationMessage, anchor) {
      ...
      const {
        valid
      } = reconcileValidty(validity, check);
...
let UeqEmotion = _decorate([n('ueq-emotion')], function (_initialize, _LitElement) {
  ...
  return {
    ...
    d: [{
      ...
      value: function styles() {
        return css`
          ...
          .container {
            ...
            grid-template-rows: 40em 40em 40em 40em 40em 40em 40em;
          }
      ...
      value: function firstUpdated(_changedProperties) {
        _get(_getPrototypeOf(UeqEmotion.prototype), "firstUpdated", this).call(this, _changedProperties);
      ...
      kind: "method",
      key: "_faceIsSelected",
      value: function _faceIsSelected(rowIndex, faceIndex) {
        return this.value.hasOwnProperty(UeqContents[this.type][rowIndex].name) && faceIndex === this.value[UeqContents[this.type][rowIndex].name];
      }
    }, {
      kind: "method",
      key: "_renderFace",
      value: function _renderFace(rowIndex, faceIndex) {
      ...
      kind: "method",
      key: "_renderRow",
      value: function _renderRow(rowData, rowIndex) {
      ...
      value: function _faceClickCallback($evt) {
        ...
        const input = target.querySelector('input'); // unselect whole row
      ...
      kind: "method",
      key: "_activateItem",
      value: function _activateItem(input) {
        input.checked = true;
      ...
      kind: "method",
      key: "_collectValues",
      value: function _collectValues() {
        return [].slice.call(this.shadowRoot.querySelectorAll('input[type=radio]:checked')).reduce((all, cur) => {
